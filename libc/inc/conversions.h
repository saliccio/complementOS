...
#define FLOAT_FRACTIONAL_SHIFT_FACTOR 10000000  // This determines the maximum number of digits converted in the fractional part

// Converts given unsigned integer src to string and writes it to given pointer. Returns the index of the null terminator.
...
// Converts given unsigned decimal value src to hexadecimal and writes it to given pointer. Returns the index of the null terminator.
int udec_to_hex(unsigned int src, char *dest);

// Converts given decimal value src to hexadecimal and writes it to given pointer. Returns the index of the null terminator.
